    ...
    public void actionPerformed(ActionEvent e){
        ...
        if(e.getSource()==bt1){
            try{
                ...
                String s="delete from issuebook where bookno='"+bookno+"' and studentid='"+studentid+"'";
                ...
                if(rest==0){
                    ...
                    if(aaa==1){
                        if(aaaa==1){
                            JOptionPane.showMessageDialog(null,"Return Book Updated");
                            this.setVisible(false);
                            
                        }
                        else{
                            JOptionPane.showMessageDialog(null,"Please fill all dtails carefully!");
